...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-hue-api/node_modules/node-hue-api/hue-api/commands/sensors-api.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-hue-api/node_modules/node-hue-api/hue-api/commands/sensors-api.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-hue-api/node_modules/node-hue-api/hue-api/commands/</a> &#187; sensors-api.js</div>
</div>
<div class="body">
...
<span class="fstat-no" title="function not covered" >function buildSensorsResult(result) {</span>
<span class="cstat-no" title="statement not covered" >    var sensors = [];</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >            sensors.push(deepExtend({id: id}, result[id]));</span>
        });
    }
<span class="cstat-no" title="statement not covered" >    return {"sensors": sensors};</span>
}
&nbsp;
