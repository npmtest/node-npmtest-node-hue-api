...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-hue-api/node_modules/node-hue-api/hue-api/commands/scenes-api.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-hue-api/node_modules/node-hue-api/hue-api/commands/scenes-api.js</span></h1>
    <h2>
        
        Statements: <span class="metric">34.29% <small>(12 / 35)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">34.29% <small>(12 / 35)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-hue-api/node_modules/node-hue-api/hue-api/commands/</a> &#187; scenes-api.js</div>
</div>
<div class="body">
...
var Trait = require("traits").Trait
  ...
  ;
&nbsp;
<span class="fstat-no" title="function not covered" >function processSceneResult(result) {</span>
<span class="cstat-no" title="statement not covered" >  var response = {}</span>
    ;
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!utils.wasSuccessful(result)) {</span>
<span class="cstat-no" title="statement not covered" >    throw new ApiError(utils.parseErrors(result).join(", "));</span>
  }
&nbsp;
<span class="fstat-no" title="function not covered" >  function processResultObject(resultEntry) {</span>
<span class="cstat-no" title="statement not covered" >    var obj = resultEntry.success</span>
      , idMatch = null
      ;
&nbsp;
<span class="cstat-no" title="statement not covered" >    Object.keys(obj).forEach(<span class="fstat-no" title="function not covered" >function (key) {</span></span>
<span class="cstat-no" title="statement not covered" >      var id = key.substr(key.lastIndexOf("/") + 1);</span>
<span class="cstat-no" title="statement not covered" >      response[id] = obj[key];</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      if (!idMatch) {</span>
<span class="cstat-no" title="statement not covered" >        idMatch = /scenes\/(.*)\//.exec(key);</span>
      }
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    if (!response.id &amp;&amp; idMatch) {</span>
<span class="cstat-no" title="statement not covered" >      response.id = idMatch[1];</span>
    }
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (Array.isArray(result)) {</span>
<span class="cstat-no" title="statement not covered" >    result.forEach(processResultObject);</span>
  } else {
<span class="cstat-no" title="statement not covered" >    processResultObject(result);</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  return response;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function validateUpdateResults(result) {</span>
<span class="cstat-no" title="statement not covered" >  var returnValue = {};</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >  if (!utils.wasSuccessful(result)) {</span>
<span class="cstat-no" title="statement not covered" >    throw new ApiError(utils.parseErrors(result).join(", "));</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  result.forEach(<span class="fstat-no" title="function not covered" >function (value) {</span></span>
<span class="cstat-no" title="statement not covered" >    Object.keys(value.success).forEach(<span class="fstat-no" title="function not covered" >function (keyValue) {</span></span>
<span class="cstat-no" title="statement not covered" >      var data = keyValue.substr(keyValue.lastIndexOf("/") + 1, keyValue.length);</span>
<span class="cstat-no" title="statement not covered" >      returnValue[data] = true;</span>
    });
  });
