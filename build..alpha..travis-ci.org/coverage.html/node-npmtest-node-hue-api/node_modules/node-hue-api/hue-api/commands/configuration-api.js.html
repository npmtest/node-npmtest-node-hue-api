...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-hue-api/node_modules/node-hue-api/hue-api/commands/configuration-api.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-hue-api/node_modules/node-hue-api/hue-api/commands/configuration-api.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-hue-api/node_modules/node-hue-api/hue-api/commands/</a> &#187; configuration-api.js</div>
</div>
<div class="body">
...
&nbsp;
&nbsp;
<span class="fstat-no" title="function not covered" >function processUserCreation(result) {</span>
<span class="cstat-no" title="statement not covered" >    return result[0].success.username;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function processDeletionResults(result) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function processModificationResults(result) {</span>
<span class="cstat-no" title="statement not covered" >    if (!utils.wasSuccessful(result)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new ApiError(utils.parseErrors(result).join(", "));</span>
    }
<span class="cstat-no" title="statement not covered" >    return true;</span>
