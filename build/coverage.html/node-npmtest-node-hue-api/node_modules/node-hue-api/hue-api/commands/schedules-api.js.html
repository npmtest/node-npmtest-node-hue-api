...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-hue-api/node_modules/node-hue-api/hue-api/commands/schedules-api.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-hue-api/node_modules/node-hue-api/hue-api/commands/schedules-api.js</span></h1>
    <h2>
        
        Statements: <span class="metric">37.93% <small>(11 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">37.93% <small>(11 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-hue-api/node_modules/node-hue-api/hue-api/commands/</a> &#187; schedules-api.js</div>
</div>
<div class="body">
...
var Trait = require("traits").Trait,
    ...
    apiTraits = {};
&nbsp;
<span class="fstat-no" title="function not covered" >function processAllSchedules(result) {</span>
...
<span class="cstat-no" title="statement not covered" >        values.push(deepExtend({id: value}, result[value]));</span>
    });
&nbsp;
<span class="cstat-no" title="statement not covered" >    return values;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function processScheduleResult(result) {</span>
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    return {id: result[0].success.id};</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function processDeletion(result) {</span>
<span class="cstat-no" title="statement not covered" >    if (!utils.wasSuccessful(result)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new ApiError(utils.parseErrors(result).join(", "));</span>
    }
&nbsp;
