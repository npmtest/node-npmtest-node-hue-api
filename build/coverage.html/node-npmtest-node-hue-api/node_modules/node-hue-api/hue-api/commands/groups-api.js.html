...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-node-hue-api/node_modules/node-hue-api/hue-api/commands/groups-api.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-node-hue-api/node_modules/node-hue-api/hue-api/commands/groups-api.js</span></h1>
    <h2>
        
        Statements: <span class="metric">44.83% <small>(13 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        ...
        Lines: <span class="metric">44.83% <small>(13 / 29)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        Ignored: <span class="metric"><span class="ignore-none">none</span></span> &nbsp;&nbsp;&nbsp;&nbsp;
    </h2>
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-node-hue-api/node_modules/node-hue-api/hue-api/commands/</a> &#187; groups-api.js</div>
</div>
<div class="body">
...
163
164
165</td><td class="line-coverage"><span class="cline-any cline-neutral">&nbsp;</span>
 ...
 * @private
 */
<span class="fstat-no" title="function not covered" >function processAllGroups(result) {</span>
<span class="cstat-no" title="statement not covered" >    var groupArray = [];</span>
&nbsp;
    // There is an implicit all lights group that is not returned in the results of the lookup, so explicitly add it
<span class="cstat-no" title="statement not covered" >    groupArray.push({id: "0", name: ALL_LIGHTS_NAME, type: "LightGroup"});</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    Object.keys(result).forEach(<span class="fstat-no" title="function not covered" >function (value) {</span></span>
<span class="cstat-no" title="statement not covered" >        groupArray.push(deepExtend({id: value}, result[value]));</span>
    });
<span class="cstat-no" title="statement not covered" >    return groupArray;</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function ensureSuccessful(result) {</span>
...
&nbsp;
<span class="fstat-no" title="function not covered" >function processCreateGroup(result) {</span>
<span class="cstat-no" title="statement not covered" >    var idString;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    ensureSuccessful(result);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    idString = result[0].success.id;</span>
<span class="cstat-no" title="statement not covered" >    idString = idString.substr(idString.lastIndexOf("/") + 1);</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >    return {id: idString};</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function processSetLightStateResult(result) {</span>
<span class="cstat-no" title="statement not covered" >    if (!utils.wasSuccessful(result)) {</span>
<span class="cstat-no" title="statement not covered" >        throw new ApiError(utils.parseErrors(result).join(", "));</span>
    }
<span class="cstat-no" title="statement not covered" >    return true;</span>
